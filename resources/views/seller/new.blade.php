...
<div class="bg-light p-5 rounded">
        @auth
        <span class="page-title">Registrar Vendedor</span>
        ...
        <div class="form-group form-floating mb-3">
            <input type="text" class="form-control" name="role" placeholder="Setor" required="required" autofocus>
        ...
        <div class="form-group form-floating mb-3">
            <input type="number" class="form-control" name="age" min="1" placeholder="Idade" required="required" autofocus>
