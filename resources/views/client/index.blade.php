...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"
    ...
    <div class="bg-light p-5 rounded">
        ...
        <div class="form-group form-floating mb-3">
            <input type="text" class="form-control" name="cpf" value="{{ old('cpf') }}" placeholder="XXXXXXXXXXX ou XXXXXXXX/0001-XX" required="required">
        ...
        <div class="form-group form-floating mb-3">
            <input type="text" class="form-control" id="cep" name="cep" value="{{ old('cep') }}" placeholder="CEP do Cliente" required="required">
        ...
        <div class="form-group form-floating mb-3">
            <input type="text" class="form-control" id="rua" name="endereco" value="{{ old('endereco') }}" placeholder="Nome do Endereço do Cliente" required="required">
        ...
        <div class="form-group form-floating mb-3">
            <input type="text" class="form-control" id="cidade" name="cidade" value="{{ old('cidade') }}" placeholder="Cidade do Cliente" required="required">
        ...
        <div class="form-group form-floating mb-3">
            <input type="text" class="form-control" name="email" value="{{ old('email') }}" placeholder="Email do Cliente" required="required">
